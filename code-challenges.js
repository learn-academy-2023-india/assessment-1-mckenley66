...
// combineAndReturnLength function takes two arrays as Parameters, concat them into a new array, and then returns the length of the combined array
function combineArrays(array1, array20){
...
// Pseudo code:In this code the `%` operator is used tocheck if a number is odd or even.
   if `test` is `true`,it logs odd numbers; 
